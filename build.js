  ...
  return layout({
    ...
    body: `
      ...
      <div class="grid home-grid">
        ...
        <article class="panel">
          <h2>Для кого сайт</h2>
          <p>Для учеников 12–14 лет и для всех, кому официальный язык стандартов кажется слишком плотным. Здесь сохранена структура документа, но фразы короче и ближе к школьным.</p>
        </article>
        <article class="panel">
          <h2>Как читать</h2>
